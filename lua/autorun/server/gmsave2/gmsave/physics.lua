...
--
function gmsave2.PhysicsSave( ent )
...
--
function gmsave2.PhysicsSaveList( ents )
	...
	for k, v in pairs( ents ) do
		...
		tabPhys[ v.GMSaveName ] = gmsave2.PhysicsSave( v );
...
--
function gmsave2.PhysicsLoad( t, ent )
...
--
function gmsave2.PhysicsLoadFromTable( tab, ents )
